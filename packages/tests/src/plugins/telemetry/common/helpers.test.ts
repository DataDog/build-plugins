...
describe('Telemetry Helpers', () => {
    ...
    test('It should use the module with webpack4', () => {
        ...
        const { getModuleName } = require('@dd/core/helpers');
    ...
    test('It should return the size of a module', () => {
        const { getModuleSize } = require('@dd/core/helpers');
    ...
    test.each([
        ...
        const { formatDuration } = require('@dd/core/helpers');
        expect(formatDuration(ms)).toBe(expected);
    });

    test('It should getContext with and without constructor', () => {
        const { getContext } = require('@dd/core/helpers');
