...
Used to automatically send your build data to Datadog.

![](../../assets/src/datadog-dashboard.png)

> [!TIP]
> You can get this dashboard's configuration [here](../../assets/src/dashboard.json)
> or by running `yarn cli dashboard --prefix <your.prefix>` at the root of this repo.
