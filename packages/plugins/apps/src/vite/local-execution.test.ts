...
describe('local-execution — executeScriptLocally', () => {
    ...
    // executeAction stands in for dev-server.ts's makeExecuteActionRemotely, whose long-poll can legitimately outlast a short hang-detection timeout — that's network wait, not a hung function.
