...
const getTemplates = (context: Context): File[] => {
    ...
    const testRoot = `packages/tests/plugins/${context.name}`;
    ...
    return [
        {
            ...
            content: (ctx) => {
                return outdent`export const CONFIG_KEY = '${ctx.name}' as const;
        ...
        },
        {
            ...
            content: (ctx) => {
                return outdent`import type { GetPlugins } from '@datadog/build-plugins-core/types';
        ...
        },
        {
            ...
            content: () => {
                return outdent`import type { GetPluginsOptionsWithCWD } from '@datadog/build-plugins-core/types';
        ...
        },
        {
            ...
            content: (ctx) => {
                return outdent`{
                        ...
                        "dependencies": {
                            "@datadog/build-plugins-core": "workspace:${pkg.version}",
                            ${ctx.esbuild ? `"esbuild": "${pkg.dependencies.esbuild}",` : ''}
                            ${ctx.webpack ? `"webpack": "${pkg.dependencies.webpack}",` : ''}
                            "unplugin": "${pkg.devDependencies.unplugin}",
                        },
                        "peerDependencies": {
                            "@datadog/build-plugins-core": "${pkg.version}",
                            ${ctx.esbuild ? `"esbuild": "*",` : ''}
                            ${ctx.webpack ? `"webpack": "*",` : ''}
                        }
                    }`;
        ...
        },
        {
            ...
            content: (ctx) => {
                return outdent`import { datadogWebpackPlugin } from '@datadog/webpack-plugin';
        ...
        },
        {
            ...
            content: (ctx) => {
                return `import { datadogEsbuildPlugin } from '@datadog/esbuild-plugin';
        ...
        },
        {
            ...
            content: () => {
                return `import type { UnpluginOptions } from 'unplugin';
        ...
        },
        {
            ...
            content: () => {
                return outdent`import type { UnpluginOptions } from 'unplugin';
